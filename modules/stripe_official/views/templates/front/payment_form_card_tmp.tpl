        ...
        <div class="form-row">
            <div id="cards-logos">
                {if isset($stripe_payment_methods)}
                    ...
                    {/foreach}
                    <img class="card_logo" src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/logo_giropay.png" />
                    <img class="card_logo" src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/logo_sofort.png" />
                {/if}
            </div>
