...
class Blocktopmenu extends Module
{
    ...
    protected function generateCategoriesMenu($categories, $is_children = 0, $hide_subcat=0)
    {
        $html = '';
        ...
        foreach ($categories as $key => $category) {
            ...
            if (isset($category['children']) && !empty($category['children'])) {
                ...
                if($category['id_category'] == 2){
                   unset($category['children'][3]);
                   unset($category['children'][4]);
                   unset($category['children'][5]);
