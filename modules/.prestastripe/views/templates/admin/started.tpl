	...
	<div class="stripe-module-wrap">
		 ...
		 <div class="stripe-module-col2">
			...
			<div class="stripe-module-col2inner">
				...
				<p><img src="{$module_dir|escape:html:'UTF-8'}/views/img/stripe-cc.png" alt="stripe" class="stripe-cc" /><a href="https://stripe.com/signup" class="stripe-module-btn" target="_blank">
