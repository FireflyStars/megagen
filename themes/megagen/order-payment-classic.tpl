            ...
            <div id="order-detail-content" class="table_block table-responsive">
                <table id="cart_summary" class="table table-bordered">
                    ...
                    {if $use_taxes}
                        ...
                        {else}
                            <tr class="cart_total_price">
                                <td colspan="4" class="text-right">{if $display_tax_label}{l s='Total products (tax incl. T.V.A)'}{else}{l s='Total products'}{/if}</td>
                    ...
                    <tr class="cart_total_voucher" {if $total_wrapping == 0}style="display:none"{/if}>
                        <td colspan="4" class="text-right">
                            {if $use_taxes}
                                ...
                                {else}
                                    {if $display_tax_label}{l s='Total gift wrapping (tax incl. T.V.A)'}{else}{l s='Total gift wrapping cost:'}{/if}
                                {/if}
                            {else}
                    ...
                    {else}
                        ...
                        {/if}
                         ...
                         <tr>
                         <td colspan="4" class="text-right">{l s='Gesamtversand (VAT)'}</td>
                         <td colspan="2" class="price" id="total_shipping_vat" >
                            {displayPrice price=($shippingCost-$total_shipping_tax_exc)}
                         </td> 
                    ...
                    {if $use_taxes}
                        {if $total_tax != 0 && $show_taxes}
                            ...
                            <tr class="cart_total_tax">
                                ...
                                <td colspan="2" class="price" id="total_tax" >{displayPrice price=$total_tax-($shippingCost-$total_shipping_tax_exc)}</td>
                            </tr>
                        {/if}
                        <tr class="cart_total_price">
