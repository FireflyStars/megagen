	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-3 col-md-3">
	        ...
	        <div id="image-block" class="clearfix">
                ...
                <a data-fancybox-group="other-views" class="fancybox" title="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}" rel="gal1" href="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')|escape:'html':'UTF-8'}">
