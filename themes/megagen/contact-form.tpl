				...
				<div class="col-xs-12 col-md-9">
					<div class="row">
						<p class="form-group col-md-4">
						    ...
						    {if isset($customerThread.customer_name)}
						        <input class="form-control grey" type="text" id="customer_name" name="customer_name" value="{$customerThread.customer_name|escape:'htmlall':'UTF-8'}" readonly="readonly" />
						    {else}
						...
						<p class="form-group col-md-4">
							...
							{else}
								<input class="form-control grey validate" type="text" id="email" name="from" data-validate="isEmail" value="{$email|escape:'html':'UTF-8'}" required />
							{/if}
						</p>
					</div>
