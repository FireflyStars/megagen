...
{assign var=tplremoveattr value=['shortimplant','Type']}


{$tmp = ksort($combinations)}
{assign var='sizesArr' value=$groups.16.attributes}
{$tmp = asort($sizesArr)}
...
<div id="product_combinations_tpl" class="row">
	...
	<div class="pb-left-column col-xs-12 col-sm-3 col-md-3">
        ...
        <div id="image-block" class="clearfix">
            ...
            <!-- {$combination.attributes_values.16} - attr_val
            {$attribute} - attr -->
                {if $combination.attributes_values.16 == $attribute && $combination.id_image !== -1}
	...
	<div class="pb-right-column col-xs-12 col-sm-7 col-md-7">
		...
		<div>
			...
			{foreach from=$combinations key=comboid item=combination}
				...
				{if $combination.attributes_values.16 == $attribute && $combination.attributes_values.5!='' }
				<tr>
...
{$tmp = ksort($combinations)}
{assign var='sizesArr' value=$groups.54.attributes}
{$tmp = asort($sizesArr)}
{foreach from=$sizesArr key=attindex item=attribute}
...
<div id="product_combinations_tpl" class="row">
	...
	<div class="pb-left-column col-xs-12 col-sm-3 col-md-3">
        ...
        <div id="image-block" class="clearfix">
            ...
            <!-- {$combination.attributes_values.16} - attr_val
            {$attribute} - attr -->
                {if $combination.attributes_values.54 == $attribute && $combination.id_image !== -1}
	...
	<div class="pb-right-column col-xs-12 col-sm-7 col-md-7">
		...
		<div>
			...
			<thead>
				<tr class="{$attribute}">
					{foreach from=$groups key=id_attribute_group item=group}
						{if !in_array( $group.name , $tplremoveattr) }
							<td>{$group.name}</td>
						{/if}
					{/foreach}
					<td>Ref.C</td>
			...
			{foreach from=$combinations key=comboid item=combination}
				...
				{if $combination.attributes_values.54 == $attribute && $combination.attributes_values.5=='' }
				<tr>
					{foreach from=$groups key=index item=group}
						{if !in_array( $group.name , $tplremoveattr) }
							<td>{$combination.attributes_values.$index|escape:'html':'UTF-8'}</td>
