...
{else}
	...
	<section class="footer-block col-xs-12" id="block_various_links_footer">
		...
		{$footer_text}
		<div id="footer_copyright">&copy; {$smarty.now|date_format:"%Y"} <a class="_blank" href="http://www.megagen.fr" target="_blank">MegaGen F.D. SA</a>. All Rights Reserved. <a href="http://www.inceptionweb.com.au/">Website Design</a></div>
