...
class FrontControllerCore extends Controller
{
	...
	public function init()
	{
		...
		/* INCEPTION WEB custom code */
		$public_php_self = array('index', 'contact', 'cms');
		if (!$this->context->customer->isLogged() && $this->php_self != 'authentication' && $this->php_self != 'password' && !in_array($this->php_self, $public_php_self)) {
			// var_dump($this->php_self);exit;
		...
		$this->context->smarty->assign(array(
			...
			'mobile_device'       => $this->context->getMobileDevice(), // mobile
			'isMobile' 			  => $mobile_class, // mobile
		));
