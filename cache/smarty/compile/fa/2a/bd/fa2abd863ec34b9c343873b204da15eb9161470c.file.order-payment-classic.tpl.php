<?php /* Smarty version Smarty-3.1.19, created on 2020-08-17 05:18:20
         compiled from "/var/www/html/themes/megagen/order-payment-classic.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2904240315f39f6fcbbcb36-04519959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa2abd863ec34b9c343873b204da15eb9161470c' => 
    array (
      0 => '/var/www/html/themes/megagen/order-payment-classic.tpl',
      1 => 1596578506,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2904240315f39f6fcbbcb36-04519959',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f39f6fcd75f34_37280849',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f39f6fcd75f34_37280849')) {function content_5f39f6fcd75f34_37280849($_smarty_tpl) {?>
...
<?php }?></td>
                        ...
                        <?php } else { ?>
                            <tr class="cart_total_price">
                                <td colspan="4" class="text-right"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total products (tax incl. T.V.A)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
...
<?php }?>
                                <?php } else { ?>
                                    <?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total gift wrapping (tax incl. T.V.A)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total gift wrapping cost:'),$_smarty_tpl);?>
<?php }?>
                                <?php }?>
                            <?php } else { ?>
...
<?php }?></td>
                        ...
                        <?php }?>
                         ...
                         <tr>
                         <td colspan="4" class="text-right"><?php echo smartyTranslate(array('s'=>'Gesamtversand (VAT)'),$_smarty_tpl);?>
</td>
                         <td colspan="2" class="price" id="total_shipping_vat" >
                            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>($_smarty_tpl->tpl_vars['shippingCost']->value-$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value)),$_smarty_tpl);?>
...
<?php }?></td>
                            ...
                            <tr class="cart_total_tax">
                                ...
                                <td colspan="2" class="price" id="total_tax" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_tax']->value-($_smarty_tpl->tpl_vars['shippingCost']->value-$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value)),$_smarty_tpl);?>
</td>
                            </tr>
                        <?php }?>
                        <tr class="cart_total_price">
