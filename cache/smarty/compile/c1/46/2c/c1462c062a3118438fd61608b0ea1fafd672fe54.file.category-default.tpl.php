<?php /* Smarty version Smarty-3.1.19, created on 2020-08-14 07:51:01
         compiled from "/var/www/html/themes/megagen/category-default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14126262905f362645013536-68008573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1462c062a3118438fd61608b0ea1fafd672fe54' => 
    array (
      0 => '/var/www/html/themes/megagen/category-default.tpl',
      1 => 1597324297,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14126262905f362645013536-68008573',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f3626450ece17_83471885',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f3626450ece17_83471885')) {function content_5f3626450ece17_83471885($_smarty_tpl) {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['category']->value)) {?>
    <?php if ($_smarty_tpl->tpl_vars['category']->value->id&&$_smarty_tpl->tpl_vars['category']->value->active) {?>
        <?php if ($_smarty_tpl->tpl_vars['scenes']->value||$_smarty_tpl->tpl_vars['category']->value->description||$_smarty_tpl->tpl_vars['category']->value->id_image) {?>
            <div class="content_scene_cat" style="margin-top: 17px;">
...
" class="lnk_more"><?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
                ...
                <?php } else { ?>
                    <!-- Category image -->
                    <div class="content_scene_cat_bg"<?php if ($_smarty_tpl->tpl_vars['category']->value->id_image) {?> style="padding: 0; background-color: transparent !important;"<?php }?>>
...
" />
                        <?php } else { ?>
                            <img class="replace-2x" src="/img/default-category.png" alt="default implasky category" width="<?php echo $_smarty_tpl->tpl_vars['categorySize']->value['width'];?>
" height="<?php echo $_smarty_tpl->tpl_vars['categorySize']->value['height'];?>
" />
                        <?php }?>
                    </a>
...
"><?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['subcategory']->value['name'],100,'...'), ENT_QUOTES, 'UTF-8', true);?>
</a></h5>
        ...
        <?php } elseif (!isset($_smarty_tpl->tpl_vars['subcategories']->value)) {?>
            <p><?php echo smartyTranslate(array('s'=>'There are currently no products for this category.'),$_smarty_tpl);?>
</p>
        <?php }?>
