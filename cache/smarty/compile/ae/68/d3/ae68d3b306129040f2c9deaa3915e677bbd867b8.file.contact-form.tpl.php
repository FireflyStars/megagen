<?php /* Smarty version Smarty-3.1.19, created on 2020-08-16 17:15:47
         compiled from "/var/www/html/themes/megagen/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:122443875f394da3441903-02773117%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae68d3b306129040f2c9deaa3915e677bbd867b8' => 
    array (
      0 => '/var/www/html/themes/megagen/contact-form.tpl',
      1 => 1596578506,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '122443875f394da3441903-02773117',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f394da35c3df1_28280378',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f394da35c3df1_28280378')) {function content_5f394da35c3df1_28280378($_smarty_tpl) {?>
				...
				<div class="col-xs-12 col-md-9">
					<div class="row">
						<p class="form-group col-md-4">
						    <label for="name"><?php echo smartyTranslate(array('s'=>'Name'),$_smarty_tpl);?>
</label>
						    <?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['customer_name'])) {?>
						        <input class="form-control grey" type="text" id="customer_name" name="customer_name" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['customerThread']->value['customer_name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" readonly="readonly" />
						    <?php } else { ?>
						        <input class="form-control grey" type="text" id="customer_name" name="customer_name" value="" required />
						    <?php }?>
						</p>
						<p class="form-group col-md-4">
